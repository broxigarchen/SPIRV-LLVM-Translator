...
; CHEKC-LLVM: call i32 addrspace(4)* addrspace(4)* @llvm.ptr.annotation.p4p4i32.p0i8(i32 addrspace(4)* addrspace(4)* %a, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @0, i32 0, i32 0), i8* undef, i32 undef, i8* undef)
...
; CHECK-LLVM: call i32 addrspace(4)* addrspace(4)* @llvm.ptr.annotation.p4p4i32.p0i8(i32 addrspace(4)* addrspace(4)* %a.i, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @0, i32 0, i32 0), i8* undef, i32 undef, i8* undef)
